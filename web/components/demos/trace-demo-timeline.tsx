...
// Custom Timeline component adapted for trace visualization
    ...
    <div className="w-full font-sans" ref={containerRef}>
      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[hsl(200_70%_60%)] to-[hsl(263_66%_28%)] flex items-center justify-center">
            <Brain className="w-5 h-5 text-white" />
          </div>
          <div>
            <h2 className="text-xl font-bold text-white">Trace Tool</h2>
        ...
        <p className="text-slate-400 text-sm">
          Watch the AI reason through quantum computing&apos;s impact on
          cryptography, revising estimates and exploring parallel solutions.
        </p>
      </div>
