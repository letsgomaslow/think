...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  useEffect(() => {
    ...
    // Handle WebGL context loss (can happen under GPU pressure)
    ...
    // Visibility-based rendering - pause when not visible to save GPU cycles
    // Track if initial render has happened - don't block first frame
    ...
    const intersectionObserver = new IntersectionObserver(
      (entries) => {
        ...
        // Skip first callback to allow initial render - observer fires immediately on setup
